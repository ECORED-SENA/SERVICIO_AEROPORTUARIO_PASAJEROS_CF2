          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-secundario(:href="obtenerLink('/downloads/Colombia_listo_para_despegar.pdf')" target="_blank")
                    span Descargar
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-acento-botones.texto-blanco(:href="obtenerLink('/downloads/Protocolo_servicio_al_cliente.pdf')" target="_blank")
                    span Descargar
                    i.fas.fa-file-download
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-acento-botones.texto-blanco(:href="obtenerLink('/downloads/Conferencia_mundial.pdf')" target="_blank")
                    span Descargar
                    i.fas.fa-file-download
